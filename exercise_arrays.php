...
<body>
	...
	<table border="1">
		...
		<tr>
			...
			<?php $price = ($product_list[0][2] > 2018) ? "900K" : "600K" ?>
			<td>Price: <?php echo $price; ?>
		...
		<tr>
			...
			<?php $price = ($product_list[1][2] > 2018) ? "900K" : "600K" ?>
			<td>Price: <?php echo $price; ?>
		...
		<tr>
			...
			<?php $price = ($product_list[2][2] > 2018) ? "900K" : "600K" ?>
			<td>Price: <?php echo $price; ?>			
		...
		<tr>
			...
			<?php $price = ($product_list[3][2] > 2018) ? "900K" : "600K" ?>
			<td>Price: <?php echo $price; ?>			
